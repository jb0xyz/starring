...
const SERVING_CODEX_CLI_VERSION: &str = "codex-cli 0.147.0-alpha.6.5";
...
mod tests {
    ...
    fn response_requires_exact_luna_medium_identity() {
        ...
        wrong_version.codex_cli_version = "codex-cli 0.146.0-alpha.3.1".to_string();
    ...
    fn health_requires_chatgpt_luna_medium() {
        ...
        health.codex_cli_version = "codex-cli 0.146.0-alpha.3.1".to_string();
