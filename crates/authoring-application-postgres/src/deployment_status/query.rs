...
use super::row::ProductDeploymentStatusRow;
...
pub(super) async fn load_status_rows(
...
) -> Result<Vec<ProductDeploymentStatusRow>, ProductDatabaseFailureV1> {
    ...
    let rows = sqlx::query_as::<_, ProductDeploymentStatusRow>(STATUS_QUERY)
