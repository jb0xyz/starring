...
fn private_study_room_descriptor_pins_every_component_and_bound() {
    ...
    assert_eq!(descriptor.extractor_revision, 12);
...
fn selected_descriptor_and_full_registry_have_distinct_stable_digests() {
    ...
    assert_eq!(
        selected,
        "d396fb75f5db2df49419ca13eb8840887530fec90586674f2e9d13b91f3b1fab"
    );
    assert_eq!(
        registry,
        "ff36b90981fd1b0898f5b63b7350eead34a91a08c2d95cab53a11752ea3f5d20"
    );
    assert_eq!(
        selected,
