...
fn private_study_room_descriptor_pins_every_component_and_bound() {
    ...
    assert_eq!(descriptor.extractor_revision, 1);
...
fn selected_descriptor_and_full_registry_have_distinct_stable_digests() {
    ...
    assert_eq!(
        selected,
        "5a6b675fc929a7f2e1237b750ed7a5232a59b0fc0e5777179781f3502750df6e"
    );
    assert_eq!(
        registry,
        "9e5440d1de3b61f677166984a45efaad84c5bccd2c39b44202f458f75fc934b5"
    );
    assert_eq!(
        selected,
