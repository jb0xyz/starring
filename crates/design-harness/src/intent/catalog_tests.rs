...
fn private_study_room_descriptor_pins_every_component_and_bound() {
    ...
    assert_eq!(descriptor.extractor_revision, 2);
...
fn selected_descriptor_and_full_registry_have_distinct_stable_digests() {
    ...
    assert_eq!(
        selected,
        "22b8659171189a061108dfd0306bc90b4c5789c2c101db2ef3f1520f414ae64b"
    );
    assert_eq!(
        registry,
        "2284385c2203f32f5b90eb836f2a5f53c4f4d2859bc6522fe8195959b2e10506"
    );
    assert_eq!(
        selected,
