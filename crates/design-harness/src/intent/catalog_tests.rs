...
fn private_study_room_descriptor_pins_every_component_and_bound() {
    ...
    assert_eq!(descriptor.normalizer_revision, 14);
...
fn selected_descriptor_and_full_registry_have_distinct_stable_digests() {
    ...
    assert_eq!(
        selected,
        "47f91cc04925f09432d8e8acca2cfbcddcbef66637273d294d7237135f442d7c"
    );
    assert_eq!(
        registry,
        "87493c40def9ffc1c9163a28bd487fed9567d3676d4798172094900303c404cc"
    );
    assert_eq!(
        selected,
