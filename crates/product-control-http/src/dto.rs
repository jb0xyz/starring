...
pub struct AuthoringTurnViewV1 {
    pub session_id: String,
    pub generation: Option<u64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub disposition: Option<AuthoringTurnDispositionV1>,
    pub projection: authoring_application::SafeAuthoringTurnProjectionV1,
}

impl Debug for AuthoringTurnViewV1 {
    fn fmt(&self, formatter: &mut Formatter<'_>) -> std::fmt::Result {
        formatter.write_str("AuthoringTurnViewV1(<redacted>)")
    }
}

#[derive(Clone, PartialEq, Serialize)]
pub struct AuthoringSessionViewV1 {
    pub session_id: String,
    pub observed_generation: u64,
    pub projection: authoring_application::SafeAuthoringTurnProjectionV1,
}

impl Debug for AuthoringSessionViewV1 {
    fn fmt(&self, formatter: &mut Formatter<'_>) -> std::fmt::Result {
        formatter.write_str("AuthoringSessionViewV1(<redacted>)")
    }
}
