...
use automation_runtime_interaction::{
    ...
    InteractionReceiptClaimRootV1, InteractionReceiptIdentityV1, InteractionRequestDigestV1,
...
/// A typed proof that a preflight snapshot was issued under one authoritative receipt claim.
///
/// The fields are intentionally private. In particular, callers cannot manufacture this proof
/// from digest-shaped strings or arbitrary canonical bytes.
