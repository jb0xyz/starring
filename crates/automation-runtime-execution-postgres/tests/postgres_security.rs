...
use automation_runtime_controller::{
    runtime_desired_target_digest_v1, RuntimeClaimNextExecutionV1, RuntimeConvergenceSessionV1,
    RuntimeExecutionReceiptV1,
};
use automation_runtime_convergence::{
    ControllerId, RuntimeDeployment, RuntimeDeploymentIdentityV1, RuntimeDeploymentSnapshotV1,
...
const EXPECTED_READINESS_DEFINITION_SHA256_V1: &str =
    "110827957fc720473b78996807daddc6a39e4f65b03cf0017aeb583ae8e38585";
...
async fn protected_counts(pool: &PgPool) -> (i64, i64, i64) {
    sqlx::query_as(
        "SELECT \
...
async fn assert_claim_and_renew_success(
    ...
    assert_eq!(protected_counts(owner_pool).await, (1, 0, 0));
}
