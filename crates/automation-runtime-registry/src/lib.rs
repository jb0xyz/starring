...
pub use registry::{
    ...
    SealedEmptyRecoveryDrainClaimV2, ServingSlotRegistryConfigV1, ServingSlotRegistryV1,
    ServingSlotSnapshotV1, SlotActivationOutcomeV1, SlotActivationRecordV2, SlotDrainClaimSealV2,
    SlotDrainObservationV1, SlotDrainOutcomeV1, SlotInstallOutcomeV1, SlotInstallReceiptV1,
    SlotLifecycleV1, SlotMutationTokenV1, SlotRemovalOutcomeV1, SlotRouteStatusV1,
    SlotRouteWitnessV1, UnsealedEmptyRecoveryDrainClaimV2,
};
