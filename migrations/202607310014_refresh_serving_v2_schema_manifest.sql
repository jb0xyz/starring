...
SELECT pg_catalog.pg_advisory_xact_lock(
    pg_catalog.hashtextextended(
        'starring-runtime-serving-heartbeat-schema-manifest-v1',
        0
    )
);

DO $serving_heartbeat_schema_manifest$
DECLARE
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'runtime_serving_heartbeat_manifest_precondition_drift';
    END IF;
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'runtime_serving_heartbeat_manifest_postcondition_drift';
    END IF;
END;
$serving_heartbeat_schema_manifest$;
