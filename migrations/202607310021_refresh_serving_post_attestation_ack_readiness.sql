...
SELECT pg_catalog.pg_advisory_xact_lock(
    pg_catalog.hashtextextended(
        'starring-runtime-serving-post-attestation-ack-readiness-v1',
        0
    )
);

DO $serving_post_attestation_ack_readiness$
DECLARE
...
BEGIN
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'runtime_serving_post_attestation_ack_readiness_precondition_drift';
    END IF;
    ...
    THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'runtime_serving_post_attestation_ack_readiness_postcondition_drift';
    END IF;
END;
$serving_post_attestation_ack_readiness$;
